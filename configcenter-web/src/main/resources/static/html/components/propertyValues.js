const propertyValuesComponentTemplate = `
<div>
    ...
    <div v-for="appProperties in appPropertieses" style="margin-bottom: 50px">
        ...
        <el-table :data="appProperties.properties" v-loading="appPropertiesesLoading" :key="appProperties.appId" :default-sort="{prop: 'key'}" border stripe>
            ...
            <el-table-column prop="value" label="属性值">
                <template slot-scope="{ row }">
                    <div v-if="!row.editing">
                        <div v-if="!row.edited">
                            <el-tag v-if="row.value === null">null</el-tag>
            ...
            <el-table-column prop="scope" label="作用域" sortable width="100px">
                <template slot-scope="{ row }">
                    <div>
...
const propertyValuesComponent = {
    template: propertyValuesComponentTemplate,
