...
public class SetPropertyValuesService {
    ...
    @ServiceExecute
    public void execute(ServiceContext<SetPropertyValuesOrder, SetPropertyValuesResult> context) {
    ...
    @ServiceAfter
    public void after(ServiceContext<SetPropertyValuesOrder, SetPropertyValuesResult> context) {
        SetPropertyValuesOrder order = context.getOrder();
